...
class Walker extends \Walker_Nav_Menu {
    ...
    public function start_lvl(&$output, $depth = 0, $args = array()) {
        ...
        if( $this->options['use_slide_effect'] == 'on' ) {
            $output .= '<li class="responsive-menu-pro-back">' . $this->options->getActiveArrow() . ' ' . $this->options['slide_effect_back_to_text'] . '</li>';
        }
    }
    ...
    public function getSubmenuClassOpenOrNot() {
        ...
        // If slide effect on then no sub item will not be active by default.
        if( $this->options['use_slide_effect'] == 'on' ) {
            return;
        }
